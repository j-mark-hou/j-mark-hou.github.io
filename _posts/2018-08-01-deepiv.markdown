...
1. discuss what nonparametric instrumental variables is, and how the DeepIV paper approaches the problem
2. re-implement the core idea of breaking nonparametric IV into two supervised learning problems, but without any deep learning
3. build a simple simulation environment and apply this re-implementation to some simulated data
4. discuss/illustrate some potential challenges to this core idea
