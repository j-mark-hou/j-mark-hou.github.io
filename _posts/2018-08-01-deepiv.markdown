...
1. deep learning is pretty popular
2. instrumental variables (and causal inference more generally) is becoming pretty popular
3. paper is pretty easy to understand
3. deep learning is actually totally ancillary to the central thrust of the paper

I'll discuss what instrumental variables is, and how this deep IV paper approaches the problem.  Then, we'll take the central idea, re-implement it without any neural networks, and do some basic validation.
...
#### II.1. Basic idea
TODO: discuss difference (quantile) and implementation details
